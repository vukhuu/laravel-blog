...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/admin/posts') }}">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ url('/admin/posts') }}">
          ...
          <span>{{ __('messages.allPosts') }}</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{ url('/admin/posts/create') }}">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>{{ __('messages.newPost') }}</span></a>
      </li>
